                    ...
                    <div className="w-full px-6 py-4 outline-sky-600 border overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg ">
                        <form onSubmit={handleSubmit}>
                            <div className="w-full">
                                ...
                                options={options} /> */}
                                <Select  className='flex  text-center items-center py-2 justify-between rounded-md' value={userType} onChange={(e)=>setUserType(e)} required>
                                    <Option value="I am a Tenant"  className=' text-blue-500 font-bold hover:bg-teal-600 hover:text-white hover:!items-center pt-2 '>I am a Tenant</Option>
                                    <Option value="I am a Landlord"  className='text-blue-500 font-bold hover:bg-teal-600 hover:text-white hover:!items-center pt-2'>I am a Landlord</Option>
                                    <Option value="I am a Service Provider"  className='text-blue-500 font-bold hover:bg-teal-600 hover:text-white hover:!items-center pt-2'>I am a Service Provider</Option>
                                    <Option value="I am a Real Estate Agent" className='text-blue-500 font-bold hover:bg-teal-600 hover:text-white hover:!items-center pt-2'>I am a Real Estate Agent</Option>
                                </Select>
                            </div>
                            <div>
